let song= new Audio("songs/7..mpeg");
let masterBtn = document.getElementById("masterBtn");
let gif = document.getElementById("gif");
let range = document.getElementById("range");
let uppperAudio = document.querySelectorAll(".audio");
...
range.addEventListener("click",function(){
    // percent convert into duration
song.currentTime = (range.value*song.duration)/100;


})
uppperAudio.forEach(function(element){
